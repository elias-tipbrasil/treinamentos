  ...
  return (
    <div className="bg-[var(--bg-surface)] border border-[var(--border)] rounded-2xl p-5 mt-6">
      ...
      >
        ...
        <span className="shrink-0 bg-[var(--tip-red)] hover:bg-[var(--tip-red-dark)] text-white px-4 py-2 font-condensed text-xs font-bold tracking-[1.3px] uppercase rounded-lg">
          {aberto ? "Ocultar" : "Ver respostas"}
        </span>
      </button>
