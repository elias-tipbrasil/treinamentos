...
import ProducaoManager from "@/components/chip/ProducaoManager";

export const dynamic = "force-dynamic";

export default async function ChipProducaoPage() {
  const user = await getCurrentUser();
  if (!user) redirect("/login");

  return (
    <section className="max-w-[1400px] mx-auto w-full px-6 py-10">
